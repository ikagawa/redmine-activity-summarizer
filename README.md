...
```bash
# Redmineのプロジェクト一覧とIDを表示
php bin/summarize.php --list-projects

# 出力例:
# ====================================================================================================
# ID    | プロジェクト名                        | 識別子                    | 説明
# ====================================================================================================
# 1     | システム管理                          | system-admin              | システム全体の管理用プロジェクト
# 2     | Webアプリケーション開発               | web-app-dev               | メインのWebアプリケーション開発
# 3     | モバイルアプリ開発                    | mobile-app                | iOS/Androidアプリの開発
# ====================================================================================================
# 合計: 3件のプロジェクト
```
...
| `-L, --list-projects` | Redmineのプロジェクト一覧とIDを表示 |
